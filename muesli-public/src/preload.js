...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  getUpcomingMeetings: (maxResults) => ipcRenderer.invoke('getUpcomingMeetings', maxResults),
  isGoogleCalendarAuthenticated: () => ipcRenderer.invoke('isGoogleCalendarAuthenticated'),
  revokeGoogleCalendarAuth: () => ipcRenderer.invoke('revokeGoogleCalendarAuth'),
